...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "satoyuya.example.com";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "BootstrapTest";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "satoyuya.example.com.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "satoyuya.example.com.";
