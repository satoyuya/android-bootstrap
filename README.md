...
* BootstrapTest is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as BootstrapTest is mean to act as a starting point for Android Applications.

# BootstrapTest App

[![Build Status](https://travis-ci.org/AndroidBootstrap/satoyuya-example-com.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/satoyuya-example-com)

This repository contains the source code for the [BootstrapTest](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=satoyuya.example.com).

Please see the [issues](https://github.satoyuya.example.com/satoyuya-example-com/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about BootstrapTest? Ask away on the [satoyuya-example-com discussion forum](https://groups.google.com/forum/#!forum/satoyuya-example-com).

<a href="https://play.google.com/store/apps/details?id=satoyuya.example.com" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __satoyuya.example.com__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____satoyuya.example.com__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.satoyuya.example.com.R__) will now be renamed
...
signed with a different key.  Manually uninstall BootstrapTest from your device and
...
BootstrapTest is a result of a template project I've developed over the years as well as
...
BootstrapTest is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.satoyuya.example.com/satoyuya-example-com/contributors) on
...
[pull requests](https://github.satoyuya.example.com/satoyuya-example-com/pulls).
